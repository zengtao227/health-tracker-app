...
object L10n {
    private val en = mapOf(
        ...
        "hr" to "Heart Rate",
        "weight" to "Weight (kg)",
        "glucose" to "Blood Glucose (mmol/L)",
        "uric_acid" to "Uric Acid (μmol/L)",
        "modules_title" to "Visible Modules",
        "enable_glucose" to "Show Blood Glucose",
        "enable_uric" to "Show Uric Acid",
        ...
        "delete_msg" to "Delete selected records?",
        "delete" to "Delete",
        "cancel" to "Cancel",
    ...
    private val zh = mapOf(
        ...
        "hr" to "心率",
        "weight" to "体重 (kg)",
        "glucose" to "血糖 (mmol/L)",
        "uric_acid" to "尿酸 (μmol/L)",
        "modules_title" to "功能模块开关",
        "enable_glucose" to "显示血糖模块",
        "enable_uric" to "显示尿酸模块",
        ...
        "ji" to "忌",
        "today_lunar" to "今日黄历",
        "confirm_delete" to "确认删除",
        "delete_msg" to "确定要删除选中的记录吗？",
        "delete" to "删除",
        "cancel" to "取消",
